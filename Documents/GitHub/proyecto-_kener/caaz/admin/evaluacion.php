...
<html lang="en">
    <head>
        ...
        <title>Evaluacion de Objetivos</title>
    ...
    <div class="wrapper">
      ...
      if($_POST)
      {
         ...
         SET $tabla.notes= '".$_POST['notes']."', $tabla.estado = '".$_POST['estado']."',
            ...
            historico.periodo2 = '".$_POST['periodo2']."',historico.calificaciona = '".$_POST['calificaciona']."',
            historico.justificacion = '".$_POST['justificacion']."'
...
<?php
      ...
      porcentaje,medida1,medida2,medida3,medida4,medida5,eva1,eva2,estado, justificacionm FROM users INNER JOIN $tabla ON users.username=cases.employee_id ";
...
<div class="panel panel-default sammacmedia">
    ...
    <thead>
      ...
      if( $_SESSION['username']== $eprow2['eva1']) if($eprow2['estado']=='4') {
        ...
        echo "<tr>";
         ...
         echo $eprow2["medida5"];
         echo "<td>";
         echo $eprow2["calificaciona"];
         echo "<td>";
         echo $eprow2["justificacion"];
         echo "<td>";
         echo "<button><b><a href=\"?id=".$eprow2["id"]."\">Evaluar</a></b></button>";
         echo "</td>";
         echo "</tr>";
 ...
 <?php
      ...
      {
         $querySelectByID = "SELECT id, case_num, notes, employee_id, severity,calificaciona,justificacion
          FROM $tabla WHERE id = ".$_GET['id'].";";
      ...
      <form action="evaluacion.php" method="post">
         ...
         <input type="hidden" value="<?=$eprow3['fechai']," ", $eprow3['fechaf']," ", $eprow3['type'];?>" name="periodo2">
         <input type="hidden" value="<?=$rowSelectByID['calificaciona'];?>" name="calificaciona">
         <input type="hidden" value="<?=$rowSelectByID['justificacion'];?>" name="justificacion">
...
?> 
      ...
      if($_POST)
      {
         ...
         { 
            $finalizado= (1);
            $sqlTaru = "UPDATE periodos SET finalizado ='$finalizado' WHERE type='Evaluacion Final' ORDER BY id DESC";
...
<div class="panel panel-default sammacmedia">
 ...
 <table class="table table-striped thead-dark table-bordered table-hover" >
    <thead>
      ...
      while($eprow2 = mysqli_fetch_array($resultado3))
      if( $_SESSION['username']== $eprow2['eva1']) if($eprow2['estado']=='9') {
 ...
 <?php
      ...
      if($eprow4['type']=='Evaluacion Final' )
      {
         $querySelectByID = "SELECT id, case_num, notes, employee_id, severity,calificaciona
          FROM $tabla WHERE id = ".$_GET['id'].";";
         $resultSelectByID = mysqli_query($link, $querySelectByID); 
         $rowSelectByID = mysqli_fetch_array($resultSelectByID);
