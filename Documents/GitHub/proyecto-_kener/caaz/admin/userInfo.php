        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">Informacion de empleado</h4></center>
                </div>
             <?php
				...
				?>
				<div class="row">
                     <p class="text-center">Empleado Id: <?php echo $prow['employee_id'];?></p>
                    <div class="col-md-4">
                    </div>
