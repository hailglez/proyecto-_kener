        ...
        <div class="panel-body">
                ...
                <tr>
                  ...
                  <a href="v_users.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="fa fa-times"></span> Remove</a>
                      ...
                      {
                          $id = $_GET['idx'];
                          if ($stmt = $mysqli->prepare("DELETE users,employees FROM users
                        JOIN employees ON users.username = employees.employee_id WHERE users.id = '".$id."' "))
                    ...
                    <strong> ¡Exito! </strong><?php echo'Registro eliminado correctamente, actualice esta página';?></div>
                    ...
                    <a href="#" class="close" data-dismiss="alert">&times;</a>
                    <strong> ¡Error! </strong><?php echo'UPS por favor intente de nuevo algo salió mal';?></div>
                    <?php
                          }
                          $mysqli->close();
