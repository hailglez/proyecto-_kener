         ...
         <div class="col-lg-2">
          ...
          <div class="col-lg-2">
            ...
            <input type="hidden"  name="justificacionm" value="<?php echo $rowSelectByID['justificacionm'];?>">
                <label><input type="radio" name="estado" value="8" required> Revisión</label><br>
                <label><input type="radio" name="estado" value="11" required> Conclusión</label><br>
            </div>
            <div class="col-lg-4">
            <label>Justificación</label>
            <textarea class="form-control"name="justificacionf" placeholder=" Describe tu justificación" required></textarea>
            </div>
            <?php } ?>
                <div class="col-lg-2">
                <label>Enviar</label>
