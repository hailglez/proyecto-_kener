...
<html lang="en">
    ...
    <body>
		...
		<div class="panel panel-default sammacmedia">
            <div class="panel-heading"> Agregar nuevo empleado
</div>
        ...
        <div class="row form-group">
          <div class="col-lg-6">
            ...
            <label>Numero de Nomina</label>
              <input type="text" class="form-control" name="employee_id" pattern="[0-9][ -]*){4}" required>
            </div>  
        </div>
            <div class="row form-group">
          <div class="col-lg-6">
            ...
            <label>Teléfono</label>
              <input type="text" class="form-control" name="phone" pattern="([0-9][ -]*){10}" placeholder="7227843512" required>
            </div>  
        </div>   
         <div class="row form-group">
          <div class="col-lg-6">
